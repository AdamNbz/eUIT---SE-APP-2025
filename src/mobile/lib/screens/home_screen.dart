            ...
            child: RefreshIndicator(
              ...
              child: SingleChildScrollView(
                ...
                padding: EdgeInsets.only(
                  ...
                  right: 20.w,
                  top: 20.h,
                  bottom: 84.h, // Updated from 88 to match new bottom nav height (68 + 16)
                ),
                child: Column(
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 12.w,
            runSpacing: 16.h,
            children: List.generate(8, (index) => _shimmerBox(80.w, 100.h, isDark)),
          ),
          SizedBox(height: 24.h),
          _shimmerBox(150.w, 24.h, isDark),
          SizedBox(height: 12.h),
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Text(
            loc.t('gpa'),
            style: TextStyle(color: isDark ? Colors.white : Colors.black87, fontSize: 18.sp),
          ),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
