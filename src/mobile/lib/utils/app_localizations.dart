...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'vi': {
      ...
      'menu_training_score_title': 'Điểm rèn luyện',
      'menu_training_score_subtitle': 'Điểm rèn luyện theo kỳ',
      'menu_training_results_title': 'Kết quả đào tạo',
      'menu_training_results_subtitle': 'Theo dõi tiến độ đào tạo',
      'menu_tuition_info_title': 'Thông tin học phí',
      'menu_tuition_info_subtitle': 'Kiểm tra học phí và hóa đơn',
      'menu_regulations_title': 'Quy chế đào tạo',
      'menu_regulations_subtitle': 'Nội quy và quy định của trường',
      'menu_training_program_title': 'Chương trình đào tạo',
      'menu_training_program_subtitle': 'Hệ chính quy và hệ từ xa',
      'menu_annual_plan_title': 'Kế hoạch năm học',
      'menu_annual_plan_subtitle': 'Lịch trình năm học, sự kiện',
    ...
    'en': {
      ...
      'menu_training_score_title': 'Training Score',
      'menu_training_score_subtitle': 'Training score per semester',
      'menu_training_results_title': 'Training Progress',
      'menu_training_results_subtitle': 'Track your training progress',
      'menu_tuition_info_title': 'Tuition Info',
      'menu_tuition_info_subtitle': 'Check tuition and invoices',
      'menu_regulations_title': 'Training Regulations',
      'menu_regulations_subtitle': 'School rules and regulations',
      'menu_training_program_title': 'Training Program',
      'menu_training_program_subtitle': 'On-campus and distance programs',
      'menu_annual_plan_title': 'Annual Plan',
      'menu_annual_plan_subtitle': 'Academic calendar and events',
      // Added keys for new dialogs/cards
